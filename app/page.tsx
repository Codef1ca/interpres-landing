    ...
    <section className="home-section">
      ...
      <div className="container-carrusel-fotos-txt">
        ...
        <div className="text-carrusel">
          ...
          <button className="boton-generico">Cursos on-line</button>
        </div>
      </div>
      ...
      <div className="text-carrusel">
          ...
          <button className="boton-generico">Contactarme</button>
          </div>
      </div>
      </div>
      ...
      <div className="text-carrusel">
          ...
          <p className="txt-carru-p">Ponte en contacto con nosotros para más información y agenda una entrevista con nuestros asesores.</p>
          <div className="container-btn">
          <button className="boton-generico">Contactarme</button>
          </div>
      </div>
